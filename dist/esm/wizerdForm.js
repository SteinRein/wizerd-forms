...
var WizerdForm = /** @class */ (function () {
    ...
    WizerdForm.prototype.prepareAddPage = function (index) {
        ...
        var page = new WizerdFormPage(tempPage, index, this.options);
    ...
    WizerdForm.prototype.addFormControl = function (key, tagName, props, inner, update) {
        ...
        var ctr = new WizerdFormControl(key, tagName, props, inner);
    ...
    WizerdForm.prototype.updateControls = function () {
        if (this.controlsWrapper !== undefined && typeof this.controlsWrapper === 'object') {
            var controls = createElement('fragment', {}, __spreadArrays(Array.from(ObjValues(this.controls), function (ctr) { return ctr.data; })));
            var $controls_1 = renderNode(controls);
            ObjValues(this.controls).forEach(function (ctr, i) {
                var ctrElement = $controls_1.childNodes[i];
                ctr.element = ctrElement;
            });
            mountChildElements($controls_1, this.controlsWrapper);
        }
    };
    WizerdForm.prototype.removeControls = function () {
        var _this = this;
        var _a;
        ObjValues(this.controls).forEach(function (ctr) {
